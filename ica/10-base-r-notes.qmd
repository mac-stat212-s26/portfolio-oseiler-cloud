...
```{r eval=FALSE}
fit_mod_and_extract <- function(data, yval, preds, predofinterest) {
    ...
    tibble(
        ...
        estimate = mod$coefficients[predofinterest],
        ci_lower = ci[predofinterest, "2.5 %"],
        ci_upper = ci[predofinterest, "97.5 %"]
    )
}

fit_mod_and_extract(mtcars,mpg,c('hp','wt'),'hp')
```
